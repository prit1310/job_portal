...
const GetJobs = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-100 to-blue-100 p-4 sm:p-6 md:p-8 lg:p-12">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-indigo-900 mb-8">Job Listings</h1>
        ...
        {jobs.length > 0 ? (
          <ul className="space-y-4">
            {jobs.map((job) => (
              <li
                key={job._id}
                className="bg-white p-6 rounded-lg shadow-md border border-gray-200 cursor-pointer hover:bg-gray-100 transition"
              >
